...
function ActionGroup<T extends object>(
  props: ValenceActionGroupProps<T>,
...
const _ActionGroup = forwardRef(ActionGroup) as <T>(
  props: ValenceActionGroupProps<T> & { ref?: DOMRef<HTMLDivElement> }
) => ReactElement;
        ...
        >
          <ActionButton
            {...{
              ...
              "aria-labelledby":
                item["aria-label"] == null && hideButtonText
                  ? textId
                  : undefined,
            }}
          >
...
function ActionGroupMenu<T>({
  ...
  if (summaryIcon) {
    ...
    summaryIcon = (
      <>
        <ChevronDown UNSAFE_className={styles["ActionGroup-menu-chevron"]} />
        <span
          {...{
            className: classNames(styles, "ActionGroup-menu-contents", {
              "ActionGroup-item--iconOnly": iconOnly,
            }),
          }}
        >
          {summaryIcon}
