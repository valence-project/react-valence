...
describe("StaticField", function () {
  it("renders a label", function () {
    let { getByText } = render(
      <StaticField data-testid="test-id" label="Field label" value="test" />
    );
  ...
  it("renders correctly with number value", function () {
    let { getByTestId } = render(
      <StaticField data-testid="test-id" label="Field label" value={10} />
    );
  ...
  it("attaches a user provided ref to the outer div", function () {
    ...
    let { getByTestId } = render(
      <StaticField data-testid="test-id" ref={ref} value="test" />
    );
  ...
  it("renders when no visible label is provided", function () {
    let { getByTestId } = render(
      <StaticField data-testid="test-id" value="test" />
    );
