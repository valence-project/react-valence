...
describe("IllustratedMessage", function () {
  ...
  `(
    "$Name should render all parts of an IllustratedMessage",
    function ({ Component, props }) {
      let { getByTestId, getByText } = renderIllustratedMessage(
        Component,
        props
      );
  ...
  `("$Name should render only an svg", function ({ Component, props }) {
    let { queryAllByText, getByTestId } = renderIllustratedMessage(
      Component,
      props
    );
  ...
  `(
    "$Name should render heading and description without an svg",
    function ({ Component, props }) {
      let { queryAllByTestId, getByText } = renderIllustratedMessage(
        Component,
        props
      );
