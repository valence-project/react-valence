...
describe("NumberField", function () {
  ...
  `("$Name has correct aria and props", () => {
    let { container, textField, incrementButton, decrementButton } =
      renderNumberField();
  ...
  it("attaches a user provided ref to the outer div with a label", function () {
    let ref = React.createRef();
    let { root, textField } = renderNumberField({
      ref,
  ...
  `(
    "$Name pressing increment & decrement keeps formatting",
  ...
  `(
    "$direction $Name starts from the right place",
    ({ direction, props, expected }) => {
      let { textField } = renderNumberField({
        onChange: onChangeSpy,
        onBlur: onBlurSpy,
        onKeyUp: onKeyUpSpy,
  ...
  `(
    "$direction $Name step 3 starts from the right place",
    ({ direction, props, expected }) => {
      let { textField } = renderNumberField({
        onChange: onChangeSpy,
        step: 3,
  ...
  `(
    "$Name typing in locale stays consistent",
    ({ props, locale, keystrokes, expected }) => {
      let { textField } = renderNumberField(
        { onChange: onChangeSpy, ...props },
        { locale }
      );
  ...
  `(
    "$Name typing group characters works",
    ({ props, locale, keystrokes, expected }) => {
      let { textField } = renderNumberField(
        { onChange: onChangeSpy, ...props },
        { locale }
  ...
  it("advances decrement starting from undefined", () => {
    let { textField, decrementButton } = renderNumberField({
      onChange: onChangeSpy,
    });
  ...
  describe("labeling", () => {
    ...
    it("aria-labelledby", () => {
      ...
      expect(incrementButton).toHaveAttribute(
        "aria-labelledby",
        `${incrementButton.id} label-id`
      );
      expect(decrementButton).toHaveAttribute("aria-label", "Decrease");
      expect(decrementButton).toHaveAttribute("id");
      expect(decrementButton).toHaveAttribute(
        "aria-labelledby",
        `${decrementButton.id} label-id`
      );
    });
  ...
  `(
    ...
    ({ props }) => {
      let { textField, incrementButton, decrementButton } =
  ...
  `(
    ...
    () => {
      ...
      let { container } = render(
        <NumberFieldControlled onChange={onChangeSpy} />
      );
      container = within(container).queryByRole("group");
  ...
  describe("beforeinput", () => {
    ...
    it.each([
      ...
      "deleteByCut",
      "deleteByDrag",
    ])("allows %s of whole currency symbol", (inputType) => {
      let { textField } = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {
          style: "currency",
    ...
    it.each([
      ...
      "deleteByCut",
      "deleteByDrag",
    ])("prevents %s of partial currency symbol", (inputType) => {
      let { textField } = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {
          style: "currency",
    ...
    ])("allows %s of number inside number", (inputType) => {
      let { textField } = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {
          style: "currency",
    ...
    it.each([
      ...
      "insertFromYank",
      "insertReplacementText",
    ])("allows %s replacing whole number", (inputType) => {
      let { textField } = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {
          style: "currency",
    ...
    it.each([
      ...
      "insertFromYank",
      "insertReplacementText",
    ])("prevents %s of number inside currency symbol", (inputType) => {
      let { textField } = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {
          style: "currency",
    ...
    it.each(["deleteContentForward"])(
      "allows %s of starting plusSign",
      (inputType) => {
        let { textField } = renderNumberField({
          onChange: onChangeSpy,
          formatOptions: {
