...
export function dimensionValue(value: DimensionValue) {
  ...
  if (FUNC_RE.test(value)) {
    return value.replace(
      ...
      "var(--valence-global-dimension-$&, var(--valence-alias-$&))"
    );
  }

  return `var(--valence-global-dimension-${value}, var(--valence-alias-${value}))`;
}
...
function colorValue(value: ColorValue, type: ColorType = "default") {
  return `var(--valence-global-color-${value}, var(--valence-semantic-${value}-color-${type}))`;
}

function backgroundColorValue(value: BackgroundColorValue) {
  return `var(--valence-alias-background-color-${value}, ${colorValue(
    value as ColorValue,
    "background"
  )})`;
}
...
function borderColorValue(value: BorderColorValue) {
  if (value === "default") {
    return "var(--valence-alias-border-color)";
  }

  return `var(--valence-alias-border-color-${value}, ${colorValue(
    value as ColorValue,
    "border"
  )})`;
}
...
function borderSizeValue(value: BorderSizeValue) {
  return `var(--valence-alias-border-size-${value})`;
}

function borderRadiusValue(value: BorderRadiusValue) {
  return `var(--valence-alias-border-radius-${value})`;
}
