...
storiesOf("ButtonGroup", module)
  ...
  .add("orientation: vertical, align: end", () =>
    render({ orientation: "vertical", align: "end" })
  )
  .add("isDisabled, orientation: vertical", () =>
    render({ isDisabled: true, orientation: "vertical" })
  )
  .add("align: end", () => render({ align: "end" }))
  .add("align: center", () => render({ align: "center" }))
  .add("align: center, orientation: vertical", () =>
    render({ align: "center", orientation: "vertical" })
  )
  .add("resizeable container", () => (
    <div
      style={{
        minWidth: "100px",
        padding: "10px",
  ...
  .add("constant container, changing siblings", () => <ExpandingSibling />);
