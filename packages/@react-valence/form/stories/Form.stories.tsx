...
storiesOf("Form", module)
  ...
  .add("custom width", () => render({ width: 400 }))
  .add("custom width, labelPosition: side", () =>
    render({ width: 400, labelPosition: "side" })
  )
  .add("labelAlign: end", () => render({ width: 400, labelAlign: "end" }))
  .add("labelPosition: side, labelAlign: end", () =>
    render({ width: 400, labelPosition: "side", labelAlign: "end" })
  )
  .add("fields next to each other", () => (
    <Form>
      <Flex>
        <TextField
          label="First Name"
  ...
  .add("fields with autoComplete property", () => {
  ...
  .add("isQuiet, labelPosition: side", () =>
  ...
  .add("validationState: invalid, isQuiet: true", () =>
    render({ validationState: "invalid", isQuiet: true })
  )
  .add("validationState: valid, isQuiet: true", () =>
    render({ validationState: "valid", isQuiet: true })
  )
  .add("form with reset", () => <FormWithControls />)
  .add("form with submit", () => <FormWithSubmit />)
  .add("form with numberfield and locale=ar-AE", () => (
    <Flex gap="size-100">
