...
<HeaderInfo packageData={packageData} componentNames={["Item", "ListView"]} />
  ...
  component={{
    ...
    props: {
      ...
      properties: Object.fromEntries(
        Object.entries(docs.exports.ListView.props.properties).filter(
          ([k, v]) => k !== "dragHooks" && k !== "dropHooks"
        )
      ),
    },
  }}
