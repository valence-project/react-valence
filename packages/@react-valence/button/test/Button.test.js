...
describe("Button", function () {
  ...
  `(
    ...
    function ({ Component }) {
      let { getByRole } = render(
        <Component data-foo="bar">Click Me</Component>
      );
  ...
  `(
    "$Name allows a custom classname on the button",
  ...
  `("$Name handles deprecated onClick", function ({ Component }) {
    ...
    let { getByRole } = render(
      <Component onClick={onPressSpy}>Click Me</Component>
    );
  ...
  `(
    "$Name can have elementType=a with an href",
    function ({ Component, props }) {
      let { getByRole } = render(<Component {...props}>Click Me</Component>);
  ...
  it("prevents default for non-submit types", function () {
    ...
    btn.current
      .UNSAFE_getDOMNode()
      .addEventListener("keydown", (e) => (eventDown = e));
    btn.current
      .UNSAFE_getDOMNode()
      .addEventListener("keyup", (e) => (eventUp = e));
