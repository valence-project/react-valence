...
import { ValenceButtonProps } from "@react-types/button";
import { storiesOf } from "@storybook/react";
import { Text } from "@react-spectrum/text";

storiesOf("Button", module)
  .addParameters({ providerSwitcher: { status: "positive" } })
  .add("variant: cta", () => render({ variant: "cta" }))
  .add("with icon", () => (
    <Flex gap="size-200">
      <Button
  ...
  .add("variant: negative", () => render({ variant: "negative" }))
  .add("element: a", () => render({ elementType: "a", variant: "primary" }))
  .add("element: a, href: '//example.com', target: '_self'", () =>
    render({
      elementType: "a",
      href: "//example.com",
      target: "_self",
  ...
  .add("element: a, rel: 'noopener noreferrer'", () =>
    render({
      elementType: "a",
      href: "//example.com",
  ...
  .add("user-select:none on press test", () => <Example />, {
    description: {
  ...
  .add("styles to check WHCM support", () => renderStyles());

function render<T extends ElementType = "button">(
  props: ValenceButtonProps<T> = { variant: "primary" }
) {
  return (
    <Flex gap="size-200">
      <Button
  ...
  return (
    <Flex gap="size-200">
      <Button
        variant="cta"
        UNSAFE_style={
          show ? undefined : { background: "red", userSelect: "text" }
        }
...
function renderStyles<T extends ElementType = "button">(
  props: ValenceButtonProps<T> = { variant: "primary" }
) {
  return (
