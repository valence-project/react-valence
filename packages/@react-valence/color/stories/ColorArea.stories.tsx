...
const Template: Story<ValenceColorAreaProps> = (args) => (
  <ColorAreaExample {...args} />
);

function ColorAreaExample(props: ValenceColorAreaProps) {
  ...
  return (
    <div
      ...
      aria-label={`${
        ariaLabel ? `${ariaLabel} ` : ""
      }${colorSpace.toUpperCase()} Color Picker`}
    >
...
XBlueYGreenisDisabled.storyName =
  'RGB xChannel="blue", yChannel="green", isDisabled';
...
XLightnessYSaturation.storyName =
  'HSL xChannel="lightness", yChannel="saturation"';
XLightnessYSaturation.args = {
  ...XBlueYGreen.args,
  xChannel: "lightness",
  yChannel: "saturation",
  defaultValue: "hsl(0, 100%, 50%)",
...
XSaturationYLightnessisDisabled.storyName =
  'HSL xChannel="saturation", yChannel="lightness", isDisabled';
XSaturationYLightnessisDisabled.args = {
  ...XSaturationYLightness.args,
  isDisabled: true,
};
...
XHueYSaturationHSLisDisabled.storyName =
  'HSL xChannel="hue", yChannel="saturation", isDisabled';
XHueYSaturationHSLisDisabled.args = {
  ...XHueYSaturationHSL.args,
  isDisabled: true,
};
...
XHueYLightnessHSLisDisabled.storyName =
  'HSL xChannel="hue", yChannel="lightness", isDisabled';
XHueYLightnessHSLisDisabled.args = {
  ...XHueYLightnessHSL.args,
  isDisabled: true,
};

export let XSaturationYBrightness = Template.bind({});
XSaturationYBrightness.storyName =
  'HSB xChannel="saturation", yChannel="brightness"';
...
XBrightnessYSaturation.storyName =
  'HSB xChannel="brightness", yChannel="saturation"';
XBrightnessYSaturation.args = {
  ...XHueYSaturationHSL.args,
  xChannel: "brightness",
  yChannel: "saturation",
  defaultValue: "hsb(0, 100%, 100%)",
...
XSaturationYBrightnessisDisabled.storyName =
  'HSB xChannel="saturation", yChannel="brightness", isDisabled';
XSaturationYBrightnessisDisabled.args = {
  ...XSaturationYBrightness.args,
  isDisabled: true,
};
...
XHueYSaturationHSBisDisabled.storyName =
  'HSB xChannel="hue", yChannel="saturation", isDisabled';
XHueYSaturationHSBisDisabled.args = {
  ...XHueYSaturationHSB.args,
  isDisabled: true,
};
...
XBrightnessYHueHSBisDisabled.storyName =
  'HSB xChannel="brightness", yChannel="hue", isDisabled';
XBrightnessYHueHSBisDisabled.args = {
  ...XBrightnessYHueHSB.args,
  isDisabled: true,
};
