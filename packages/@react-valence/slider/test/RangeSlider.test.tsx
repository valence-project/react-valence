...
describe("RangeSlider", function () {
  ...
  it("supports label", function () {
    ...
    expect(leftSlider.getAttribute("aria-labelledby")).toBe(
      `${labelId} ${leftSlider.id}`
    );
    expect(rightSlider.getAttribute("aria-labelledby")).toBe(
      `${labelId} ${rightSlider.id}`
    );
  ...
  it("supports showValueLabel: false", function () {
    let { getByRole, queryByRole } = render(
      <RangeSlider label="The Label" showValueLabel={false} />
    );
    let group = getByRole("group");
  ...
  it("can be controlled", function () {
    ...
    function Test() {
      ...
      return (
        <RangeSlider label="The Label" value={value} onChange={setValue} />
      );
    }
  ...
  describe("keyboard interactions", () => {
    ...
    `(
      ...
      function ({ props, commands }) {
        ...
        let sliders = tree.getAllByRole("slider") as [
          HTMLInputElement,
          HTMLInputElement
        ];
  ...
  describe("mouse interactions", () => {
    ...
    it("can click on track to move nearest handle", () => {
      ...
      // @ts-ignore
      let [leftTrack, middleTrack, rightTrack] = [
        ...thumbLeft.parentElement.children,
      ].filter((c) => c !== thumbLeft && c !== thumbRight);
