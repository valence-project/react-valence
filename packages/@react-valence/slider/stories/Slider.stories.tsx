...
import { Slider } from "../";
import { ValenceSliderProps } from "@react-types/slider";
...
storiesOf("Slider", module)
  ...
  .add("custom width small", () => render({ label: "Label", width: "30px" }))
  .add("label overflow", () =>
    render({
  ...
  .add("labelPosition: side, customWidth", () =>
    render({ label: "Label", labelPosition: "side", width: "400px" })
  )
  .add("labelPosition: side, customWidth small", () =>
  ...
  .add("isFilled: true", () => render({ label: "Label", isFilled: true }))
  .add("fillOffset", () =>
    render({
      label: "Exposure",
      isFilled: true,
  ...
  .add("trackGradient with fillOffset", () =>
    render({
      label: "Label",
...
function render(props: ValenceSliderProps = {}) {
