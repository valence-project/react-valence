...
storiesOf("Checkbox", module)
  ...
  .add("Default", () => render())
  .add("defaultSelected: true", () => render({ defaultSelected: true }))
  .add("isSelected: true", () => render({ isSelected: true }))
  .add("isSelected: false", () => render({ isSelected: false }))
  .add("isIndeterminate: true", () => render({ isIndeterminate: true }))
  ...
  .add("isEmphasized: true, isIndeterminate: true", () =>
    render({ isEmphasized: true, isIndeterminate: true })
  )
  .add('isEmphasized: true, validationState: "invalid"', () =>
  ...
  .add("isEmphasized: true, isDisabled: true", () =>
    render({ isEmphasized: true, isDisabled: true })
  )
  .add("isReadOnly: true, isSelected: true", () =>
...
function renderRow(props = {}) {
  return (
    <Flex gap="size-200">
      ...
      <Checkbox isDisabled onChange={action("change")} {...props}>
        Option
      </Checkbox>
    </Flex>
  );
