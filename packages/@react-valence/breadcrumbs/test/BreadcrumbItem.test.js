...
describe("BreadcrumbItem", function () {
  it("Handles defaults", () => {
    let { getByText } = render(
      <BreadcrumbItem>Breadcrumb item</BreadcrumbItem>
    );
  ...
  it("Handles current", () => {
    let { getByText } = render(
      <BreadcrumbItem isCurrent>Breadcrumb item</BreadcrumbItem>
    );
    let breadcrumbItem = getByText("Breadcrumb item");
  ...
  it("Handles onPress", () => {
    let onPressSpy = jest.fn();
    let { getByText } = render(
      <BreadcrumbItem onPress={onPressSpy}>Breadcrumb item</BreadcrumbItem>
    );
    let breadcrumbItem = getByText("Breadcrumb item");
    triggerPress(breadcrumbItem);
