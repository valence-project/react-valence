...
storiesOf("Picker", module)
  ...
  .add("optional, necessityIndicator: label", () => (
    <Picker
      label="Test"
      necessityIndicator="label"
      onSelectionChange={action("selectionChange")}
  ...
  .add("isQuiet, isRequired, necessityIndicator: label", () => (
    <Picker
      label="Test"
      isQuiet
      isRequired
  ...
  .add("isQuiet, optional, necessityIndicator: label", () => (
    <Picker
      label="Test"
      isQuiet
      necessityIndicator="label"
  ...
  .add("isQuiet, validationState: invalid", () => (
    <Picker
      label="Test"
      isQuiet
      validationState="invalid"
  ...
  .add("custom widths, labelPosition: side", () => (
    <Flex direction="column">
      <Picker
        label="Test"
        width="size-1200"
  ...
  .add("custom menu widths, isQuiet", () => (
    <Flex direction="column">
      <Picker
        label="Test"
        menuWidth="size-400"
  ...
  .add("custom menu width, align: end", () => (
    <Picker
      label="Test"
      menuWidth="size-6000"
      align="end"
