...
export function CRUDExample() {
  ...
  let selectedCount =
    list.selectedKeys === "all" ? list.items.length : list.selectedKeys.size;
  ...
  return (
    <Flex direction="column">
      ...
      <DialogContainer onDismiss={() => setDialog(null)}>
        {dialog?.action === "add" && (
          <EditDialog item={null} onConfirm={createItem} />
        )}
        {dialog?.action === "edit" && (
          <EditDialog
            item={dialog.item}
        ...
        {dialog?.action === "delete" && (
          ...
          >
            Are you sure you want to delete {dialog.item.firstName}{" "}
            {dialog.item.lastName}?
          </AlertDialog>
        )}
