...
describe("TableViewSizing", function () {
  ...
  describe("resizing columns", function () {
    ...
    describe("touch", () => {
      ...
      it("dragging the resizer works - mobile", () => {
        ...
        fireEvent.pointerDown(resizableHeader, {
          pointerType: "touch",
          pointerId: 1,
        });
        fireEvent.pointerUp(resizableHeader, {
          pointerType: "touch",
          pointerId: 1,
        });
        act(() => {
        ...
        fireEvent.pointerDown(resizeMenuItem, {
          pointerType: "touch",
          pointerId: 1,
        });
        fireEvent.pointerUp(resizeMenuItem, {
          pointerType: "touch",
          pointerId: 1,
        });
        act(() => {
  ...
  describe("updating columns", function () {
    ...
    it("should update the row widths when removing and adding columns", function () {
      ...
      act(() => jest.runAllTimers());
      expect(parseInt(rows[1].childNodes[1].style.width, 10)).toBeLessThan(
  ...
  describe("headerless columns", function () {
    let renderTable = (props, scale, showDivider = false) =>
      render(
