...
storiesOf("Progress/ProgressBar", module)
  ...
  .add("Default", (args) => render(args))
  .add("value: 50", () => render({ value: 50 }))
  .add("value: 100", () => render({ value: 100 }))
  .add("size: S", (args) => render({ size: "S", ...args }))
  .add("showValueLabel: true", (args) =>
    render({ showValueLabel: true, ...args })
  )
  .add("showValueLabel: false", (args) =>
  ...
  .add("no visible label", (args) =>
    render({ label: null, "aria-label": "Loading…", ...args })
  )
  .add("labelPosition: side", (args) =>
    render({ labelPosition: "side", ...args })
  )
  .add("labelPosition: top", (args) =>
  ...
  .add("long label, labelPosition: side", (args) =>
    render({
      labelPosition: "side",
      label: "Super long progress bar label. Sample label copy. Loading...",
      ...args,
