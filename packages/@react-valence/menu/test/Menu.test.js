...
describe("Menu", function () {
  ...
  describe("supports single selection", function () {
    ...
    `(
      ...
      function ({ Component, props }) {
        ...
        fireEvent.keyUp(nextSelectedItem, {
          key: "Enter",
          code: 13,
          charCode: 13,
        });
    ...
    `(
      "$Name supports selectedKeys (controlled)",
      function ({ Component, props }) {
        // Check that correct menu item is selected by default
        let tree = renderComponent(Component, {}, props);
        let menu = tree.getByRole("menu");
    ...
    `(
      "$Name supports using space key to change item selection",
      function ({ Component, props }) {
        let tree = renderComponent(Component, {}, props);
        let menu = tree.getByRole("menu");
        let menuItems = within(menu).getAllByRole("menuitemradio");
    ...
    it.each`
      ...
      ${"Menu"} | ${Menu}   | ${{ selectionMode: "single", onSelectionChange }}
    `(
      "$Name supports using click to change item selection",
      function ({ Component, props }) {
        let tree = renderComponent(Component, {}, props);
        let menu = tree.getByRole("menu");
        let menuItems = within(menu).getAllByRole("menuitemradio");
  ...
  describe("supports multi selection", function () {
    ...
    `(
      "$Name supports selecting multiple items",
      function ({ Component, props }) {
        let tree = renderComponent(Component, {}, props);
        let menu = tree.getByRole("menu");
    ...
    `(
      "$Name supports multiple selectedKeys (controlled)",
      function ({ Component, props }) {
        let tree = renderComponent(Component, {}, props);
        let menu = tree.getByRole("menu");
  ...
  describe("supports type to select", function () {
    ...
    it.each`
      ...
      ${"Menu"} | ${Menu}   | ${{ autoFocus: "first" }}
    `(
      "$Name resets the search text after a timeout",
      function ({ Component, props }) {
        let tree = renderComponent(Component, {}, props);
        let menu = tree.getByRole("menu");
        let menuItems = within(menu).getAllByRole("menuitem");
    ...
    it.each`
      ...
      ${"Menu"} | ${Menu}   | ${{ autoFocus: "first" }}
    `(
      "$Name wraps around when no items past the current one match",
      function ({ Component, props }) {
        let tree = renderComponent(Component, {}, props);
        let menu = tree.getByRole("menu");
        let menuItems = within(menu).getAllByRole("menuitem");
