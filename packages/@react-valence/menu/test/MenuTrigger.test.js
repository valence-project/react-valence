...
describe("MenuTrigger", function () {
  ...
  `(
    "$Name has default behavior (button renders, menu is closed)",
    function ({ Component }) {
  ...
  `(
    "$Name toggles the menu display on button click",
  ...
  it.each`
    ...
    ${"MenuTrigger"} | ${MenuTrigger} | ${{ onOpenChange }}
  `(
    "$Name can toggle the menu display via ArrowUp key",
    function ({ Component, props }) {
  ...
  it.each`
    ...
    ${"MenuTrigger"} | ${MenuTrigger} | ${{ onOpenChange }}
  `(
    "$Name can toggle the menu display via ArrowDown key",
    function ({ Component, props }) {
      verifyMenuToggle(Component, props, {}, (button, menu) => {
        if (!menu) {
  ...
  `(
    "$Name supports a uncontrolled default open state ",
    function ({ Component, props }) {
      let tree = renderComponent(Component, props);
      act(() => {
        jest.runAllTimers();
  ...
  it.each`
    ...
    ${"MenuTrigger"} | ${MenuTrigger} | ${{ onOpenChange }}
  `(
    "$Name does not trigger on disabled button",
    function ({ Component, props }) {
  ...
  describe("default focus behavior", function () {
    it.each`
      ...
      ${"MenuTrigger"} | ${MenuTrigger} | ${{}}
    `(
      "$Name autofocuses the selected item on menu open",
      function ({ Component, props }) {
    ...
    it.each`
      ...
      ${"MenuTrigger"} | ${MenuTrigger} | ${{}}
    `(
      "$Name focuses the last item on ArrowUp if there isn't a selected item",
      function ({ Component, props }) {
        let tree = renderComponent(Component, props, {});
        let button = tree.getByRole("button");
        fireEvent.keyDown(button, { key: "ArrowUp", code: 38, charCode: 38 });
    ...
    it.each`
      ...
      ${"MenuTrigger"} | ${MenuTrigger} | ${{}}
    `(
      "$Name focuses the first item on ArrowDown if there isn't a selected item",
      function ({ Component, props }) {
        let tree = renderComponent(Component, props, {});
        let button = tree.getByRole("button");
        fireEvent.keyDown(button, { key: "ArrowDown", code: 40, charCode: 40 });
    ...
    it.each`
      ...
      ${"MenuTrigger"} | ${MenuTrigger} | ${{}}
    `(
      "$Name moves focus via ArrowDown and ArrowUp",
      function ({ Component, props }) {
        let tree = render(
          <Provider theme={theme}>
            <div data-testid="scrollable">
  ...
  describe("menu popover closing behavior", function () {
    ...
    it.each`
      ...
      ${"MenuTrigger"} | ${MenuTrigger} | ${{ onOpenChange }}
    `(
      "$Name closes the menu upon trigger body scroll",
      function ({ Component, props }) {
    ...
    it.each`
      ...
      ${"MenuTrigger"} | ${MenuTrigger} | ${{ onOpenChange }}
    `(
      "$Name closes the menu upon clicking escape key",
      function ({ Component, props }) {
        tree = renderComponent(Component, props);
        let button = tree.getByRole("button");
        triggerPress(button);
    ...
    it.each`
      ...
      ${"MenuTrigger"} | ${MenuTrigger} | ${{ onOpenChange }}
    `(
      "$Name closes the menu upon clicking outside the menu",
      function ({ Component, props }) {
        tree = renderComponent(Component, props);
        let button = tree.getByRole("button");
        triggerPress(button);
    ...
    `(
      "$Name doesn't close menu on item selection via mouse with multiple selection",
      function ({ Component, props, menuProps }) {
        tree = renderComponent(Component, props, menuProps);
        openAndTriggerMenuItem(
          tree,
          props.role,
          menuProps.selectionMode,
          (item) => triggerPress(item)
        );
    ...
    it.each`
      ...
      ${"MenuTrigger none"}     | ${MenuTrigger} | ${{}} | ${{ selectionMode: "none" }}
    `(
      "$Name closes on menu item selection if toggled by ENTER key",
      function ({ Component, props, menuProps }) {
        tree = renderComponent(Component, props, menuProps);
        openAndTriggerMenuItem(
          tree,
          ...
          menuProps.selectionMode,
          (item) =>
            fireEvent.keyDown(item, { key: "Enter", code: 13, charCode: 13 })
        );
    ...
    it.each`
      ...
      ${"MenuTrigger multiple"} | ${MenuTrigger} | ${{}} | ${{ selectionMode: "multiple" }}
    `(
      '$Name doesn\'t close on menu item selection if toggled by SPACE key (all selection modes except "none")',
      function ({ Component, props, menuProps }) {
        tree = renderComponent(Component, props, menuProps);
        openAndTriggerMenuItem(
          tree,
    ...
    it.each`
      ...
      ${"MenuTrigger none"} | ${MenuTrigger} | ${{}} | ${{ selectionMode: "none" }}
    `(
      "$Name closes on menu item selection if toggled by SPACE key (selectionMode=none)",
      function ({ Component, props, menuProps }) {
        tree = renderComponent(Component, props, menuProps);
        openAndTriggerMenuItem(
          tree,
    ...
    it.each`
      ...
      ${"MenuTrigger"} | ${MenuTrigger} | ${{ onOpenChange }}
    `(
      "$Name closes the menu when blurring the menu",
      function ({ Component, props }) {
        tree = renderComponent(Component, props, {});
        expect(onOpenChange).toBeCalledTimes(0);
        let button = tree.getByRole("button");
    ...
    it.each`
      ...
      ${"MenuTrigger none"}     | ${MenuTrigger} | ${{}} | ${{ selectionMode: "none" }}
    `(
      "$Name ignores repeating keyboard events",
      function ({ Component, props, menuProps }) {
        tree = renderComponent(Component, props, menuProps);
        openAndTriggerMenuItem(
          tree,
    ...
    it("works with a ref on both the button and menu trigger", function () {
      ...
      expect(menuTriggerRef.current.UNSAFE_getDOMNode()).toBe(
        getByRole("button")
      );
  ...
  describe('MenuTrigger trigger="longPress" open behavior', function () {
    ...
    it("should open the menu on longPress", function () {
      ...
      verifyMenuToggle(MenuTrigger, props, {}, (button, menu) => {
        ...
        ).toHaveTextContent("Long press or press Alt + ArrowDown to open menu");
