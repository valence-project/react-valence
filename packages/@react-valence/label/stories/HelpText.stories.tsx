...
import { ValenceTextFieldProps } from "@react-types/textfield";
...
const argTypes = {
  ...
  width: {
    ...
    options: [
      "100px",
      "440px",
      "var(--spectrum-global-dimension-top, var(--spectrum-alias-top))",
    ],
  },
};
...
function TextFieldWithValidationState(props: ValenceTextFieldProps) {
