...
storiesOf("Date and Time/TimeField", module)
  ...
  .add("default", () => render())
  .add("defaultValue", () => render({ defaultValue: parseTime("20:24") }))
  .add("controlled value", () => render({ value: new Time(2, 35) }))
  ...
  .add("hourCycle: 12, granularity: hour", () =>
    render({ hourCycle: 12, granularity: "hour" })
  )
  .add("hourCycle: 24, granularity: hour", () =>
  ...
  .add("isDisabled", () => render({ isDisabled: true, value: new Time(2, 35) }))
  .add("isQuiet, isDisabled", () =>
    render({ isQuiet: true, isDisabled: true, value: new Time(2, 35) })
  )
  .add("isReadOnly", () => render({ isReadOnly: true, value: new Time(2, 35) }))
  ...
  .add("minValue: 8 AM", () => render({ minValue: new Time(8) }))
  .add("maxValue: 8 PM", () => render({ maxValue: new Time(20) }))
...
storiesOf("Date and Time/TimeField/styling", module)
  ...
  .add("no visible label", () => render({ "aria-label": "Time", label: null }))
