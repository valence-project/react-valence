...
//   .add("default", () => render())
//   .add("defaultValue", () => render({ defaultValue: parseDate("2020-02-03") }))
...
//   .add("granularity: minute, defaultValue", () =>
//     render({
//       granularity: "minute",
//       defaultValue: parseDateTime("2021-03-14T08:45"),
//     })
//   )
//   .add("granularity: minute, defaultValue, zoned", () =>
//     render({
//       granularity: "minute",
...
//     })
//   )
//   .add("defaultValue with time, granularity: day", () =>
//     render({
//       granularity: "day",
//       defaultValue: parseDateTime("2021-03-14T08:45"),
//     })
...
//   )
//   .add("minValue: 2010/1/1, maxValue: 2020/1/1", () =>
//     render({
...
//   )
//   .add("placeholderValue: 1980/1/1 8 AM", () =>
//     render({ placeholderValue: new CalendarDateTime(1980, 1, 1, 8) })
//   )
//   .add("placeholderValue: 1980/1/1, zoned", () =>
//     render({
...
//   .add("no visible label", () => render({ "aria-label": "Date", label: null }))
