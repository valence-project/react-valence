...
describe("Toast", function () {
  ...
  `("$name handles defaults", function ({ name, Component, props, message }) {
    let { getAllByRole, getByRole, getByText } = renderComponent(
      Component,
      props,
      message
    );
  ...
  `(
    "$Name supports UNSAFE_className",
    function ({ Component, props, message }) {
  ...
  `(
    "$Name handles action and close button clicks",
    function ({ Component, props, message }) {
      let { getAllByRole, getByText } = renderComponent(
        Component,
        { onClose, onAction, ...props },
        message
      );
  ...
  `(
    "$Name handles action and close button clicks when action closes",
    function ({ Component, props, message }) {
      let { getAllByRole, getByText } = renderComponent(
        Component,
        { onClose, onAction, ...props },
  ...
  it.each`
    ...
    ${"Toast"} | ${Toast}  | ${{ actionLabel: "Undo", shouldCloseOnAction: true, onRemove }} | ${"Toast time!"}
  `(
    "$Name action button and close button are focusable",
    function ({ Component, props, message }) {
