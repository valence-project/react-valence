...
// @types-valence
import { DOMRef, DOMRefValue, Node } from "@types-valence/shared";
import { ValenceCardViewProps } from "@types-valence/card";
...
function CardView<T extends object>(
  ...
  return (
    <CardViewContext.Provider
      value={{ state, isQuiet, layout: cardViewLayout, cardOrientation }}
    >
      <Virtualizer
        {...gridProps}
        {...styleProps}
        className={classNames(styles, "valence-CardView")}
        ref={domRef}
...
function CenteredWrapper({ children }) {
  ...
  return (
    <div
      ...
      className={classNames(styles, "valence-CardView-centeredWrapper")}
    >
...
function InternalCard(props) {
  ...
  return (
    <div
      {...rowProps}
      ref={rowRef}
      className={classNames(styles, "valence-CardView-row")}
    >
      <CardBase
        ref={cellRef}
 ...
 */
const _CardView = React.forwardRef(CardView) as <T>(
  props: ValenceCardViewProps<T> & { ref?: DOMRef<HTMLDivElement> }
) => ReactElement;
