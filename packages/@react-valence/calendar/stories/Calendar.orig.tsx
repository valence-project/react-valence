...
storiesOf("Date and Time/Calendar", module)
  ...
  .add("with time", () => <CalendarWithTime />)
  .add("with zoned time", () => <CalendarWithZonedTime />)
  ...
  .add("minValue, visibleMonths: 3, defaultValue", () =>
    render({
  ...
  .add("defaultFocusedValue", () =>
    render({ defaultFocusedValue: new CalendarDate(2019, 6, 5) })
  )
  .add("focusedValue", () => <ControlledFocus />)
  ...
  .add("aria-label", () => render({ "aria-label": "Appointment date" }));
...
function ControlledFocus() {
  ...
  return (
    <Flex direction="column" alignItems="start" gap="size-200">
      <ActionButton
        onPress={() => setFocusedDate(new CalendarDate(2019, 6, 5))}
      >
        Reset focused date
      </ActionButton>
