...
storiesOf("DialogTrigger", module)
  ...
  .add("nested modals", () => (
    <div style={{ paddingTop: 100 }}>
      ...
      <Provider
        colorScheme="dark"
        UNSAFE_style={{ padding: 40, marginTop: 10 }}
      >
  ...
  .add("nested modals, fullscreentakeover", () => (
  ...
  .add('placement="right", shouldFlip="false"', () =>
    renderPopover({ type: "popover", placement: "right", shouldFlip: false })
  )
  .add('placement="right top", shouldFlip="false"', () =>
    renderPopover({
      type: "popover",
      placement: "right top",
      shouldFlip: false,
  ...
  .add('placement="right bottom", shouldFlip="false"', () =>
    renderPopover({
      type: "popover",
  ...
  .add('placement="bottom", shouldFlip="false"', () =>
    renderPopover({ type: "popover", placement: "bottom", shouldFlip: false })
  )
  .add('placement="bottom left", shouldFlip="false"', () =>
    renderPopover({
      type: "popover",
  ...
  .add('placement="bottom right", shouldFlip="false"', () =>
    renderPopover({
      type: "popover",
  ...
  .add("offset", () => renderPopover({ type: "popover", offset: 50 }))
  .add("crossOffset", () => renderPopover({ type: "popover", crossOffset: 50 }))
  .add("shouldFlip: true", () =>
    renderPopover({
      type: "popover",
      placement: "start",
  ...
  .add("adjustable dialog", () => <AdjustableDialog />);
