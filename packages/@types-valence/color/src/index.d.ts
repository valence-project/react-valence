...
import { SliderProps } from "@types-valence/slider";
...
export interface ColorFieldProps
  extends Omit<ValueBase<string | Color | null>, "onChange">,
    InputBase,
    Validation,
    FocusableProps,
    TextInputBase,
...
export interface ValenceColorFieldProps
...
export interface ColorWheelProps
  extends Omit<ValueBase<string | Color>, "onChange"> {
...
export interface AriaColorWheelProps
  extends ColorWheelProps,
    DOMProps,
    AriaLabelingProps {}

export interface ValenceColorWheelProps
...
export interface AriaColorSliderProps
  extends ColorSliderProps,
    DOMProps,
    AriaLabelingProps {}

export interface ValenceColorSliderProps
...
export interface AriaColorAreaProps
  extends ColorAreaProps,
    DOMProps,
    AriaLabelingProps {}

export interface ValenceColorAreaProps
