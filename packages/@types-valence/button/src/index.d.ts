...
export interface ValenceButtonProps<T extends ElementType = "button">
...
export interface ValenceActionButtonProps
  extends AriaBaseButtonProps,
    ButtonProps,
    StyleProps {
...
export interface ValenceLogicButtonProps
  extends AriaBaseButtonProps,
    ButtonProps,
    StyleProps {
...
export interface ValenceToggleButtonProps
  extends ToggleButtonProps,
