...
export interface ValenceBarSliderBase<T>
...
export interface ValenceSliderProps extends ValenceBarSliderBase<number> {
  /**
...
export interface ValenceRangeSliderProps
  extends ValenceBarSliderBase<RangeValue<number>> {}
