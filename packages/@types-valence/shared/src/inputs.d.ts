...
export interface ValenceTextInputBase {
  /**
   * Temporary text that occupies the text input when it is empty.
...
// Valence specific types. Extends `Validation` so that the `validationState` prop is available.
export interface ValenceHelpTextProps extends HelpTextProps, Validation {
