...
export type ValenceDialogClose = (close: () => void) => ReactElement;

export interface ValenceDialogTriggerProps
  ...
  children: [ReactElement, ValenceDialogClose | ReactElement];
  /**
...
export interface ValenceDialogContainerProps {
...
export interface ValenceDialogProps extends AriaDialogProps, StyleProps {
...
export interface ValenceAlertDialogProps extends DOMProps, StyleProps {
